...
def _sqrtm_triu(T, blocksize=32):
    """
    ...
    """
        ...
        #Blocked Real Schur Sqrtm
        for start,stop in start_stop_pairs:
            #print T[start:stop,start:stop]
        return 0
"""
...
def sqrtm(A, disp=True, blocksize=3):
    """
    Matrix square root.
